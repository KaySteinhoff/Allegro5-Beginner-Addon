...
public:
	...
	ALLEGRO_COLOR _GetColor(float lum)
	{
		...
		switch (pixel_bw)
		{
			case 0: fg_col = al_map_rgb(0, 0, 0); break;

			case 1: fg_col = al_map_rgb(25, 25, 25); break;
			case 2: fg_col = al_map_rgb(45, 45, 45); break;
			case 3: fg_col = al_map_rgb(65, 65, 65); break;
			case 4: fg_col = al_map_rgb(85, 85, 85); break;
					
			case 5: fg_col = al_map_rgb(100, 100, 100); break;
			case 6: fg_col = al_map_rgb(120, 120, 120); break;
			case 7: fg_col = al_map_rgb(145, 145, 145); break;
			case 8: fg_col = al_map_rgb(165, 165, 165); break;
					
			case 9: fg_col = al_map_rgb(180, 180, 180); break;
			case 10: fg_col = al_map_rgb(200, 200, 200); break;
			case 11: fg_col = al_map_rgb(220, 220, 220); break;
			case 12: fg_col = al_map_rgb(255, 255, 255); break;
			default:
				fg_col = al_map_rgb(0, 0, 0);
		}
